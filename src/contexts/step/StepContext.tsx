import { createContext, ReactNode, Dispatch, SetStateAction, useCallback, useMemo, useState } from 'react'
...
function StepContextProvider({ children }: StepContextProps) {
    ...
    const [currentStep, setCurrentStep] = useState<number>(intialValue.currentStep)
    const [maxStep, setMaxStep] = useState<number>(5); // TO DO: set this dynamically

    console.log('StepContextProvider maxStep', maxStep)
